...
use app\tax\service\PostService;
...
/**
 * Class AdminTaxArticleController
 ...
 *
 */
class AdminTaxArticleController extends AdminBaseController
{
    /**
     * 新闻列表
     * @adminMenu(
    ...
    public function addPost()
    {
        if ($this->request->isPost()) {
            ...
            $post   = $data['post'];
            $result = $this->validate($post, 'TaxArticle');
            if ($result !== true) {
                $this->error($result);
            }
            ...
            $this->success('添加成功!', url('AdminTaxArticle/edit', ['id' => $portalPostModel->id]));
        }
    ...
    public function delete()
    {
        ...
        if (isset($param['id'])) {
            ...
            if ($resultPortal) {
                Db::name('tax_portal_category_post')->where(['post_id'=>$id])->update(['status'=>0]);
                Db::name('tax_portal_tag_post')->where(['post_id'=>$id])->update(['status'=>0]);
            }
            $this->success("删除成功！", '');
    ...
    {
        parent::listOrders(Db::name('tax_portal_category_post'));
        $this->success("排序更新成功！", '');
    }
